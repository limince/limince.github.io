...
3. Add the CV file and set its path in the `contact.cv` field. The CV button stays hidden while this field is empty.
4. Replace `mince-li.jpg` when a new homepage portrait is ready, or update the image path in `index.html`.
